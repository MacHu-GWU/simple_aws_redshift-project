# -*- coding: utf-8 -*-
#
# simple_aws_redshift documentation build configuration file, created by
...
import simple_aws_redshift as package
...
# Add data for Jinja2
try:
    from simple_aws_redshift.docs import doc_data
except:
    doc_data = dict()
